 ...
 */
@Handler(supports = PCSPreCovidSymptomsDataDefinition.class, order = 50)
public class PCSPreCovidSymptomsDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id, pre_covid_symptoms from kenyaemr_etl.etl_cca_post_covid_screening ";
