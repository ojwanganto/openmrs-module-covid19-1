 ...
 */
@Handler(supports = PCSNextAppointmentDateDataDefinition.class, order = 50)
public class PCSNextAppointmentDateDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id, appointment_date from kenyaemr_etl.etl_cca_post_covid_screening ";
