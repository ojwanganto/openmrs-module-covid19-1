 ...
 */
@Handler(supports = PCSCompleteVaccinationDosesDataDefinition.class, order = 50)
public class PCSCompleteVaccinationDosesDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id, completed_vaccination_doses from kenyaemr_etl.etl_cca_post_covid_screening ";
