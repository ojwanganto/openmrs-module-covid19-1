 ...
 */
@Handler(supports = PCSConsentForFollowupDataDefinition.class, order = 50)
public class PCSConsentForFollowupDateDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id, case consented_for_followup when 1 then 'Yes' when 2 then 'No' else '' end as consent from kenyaemr_etl.etl_cca_post_covid_screening ";
