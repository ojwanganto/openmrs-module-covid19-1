...
/**
 * Calculates a patient's eligibility for NCD initial encounter
 */
public class ShowNCDInitialFormCalculation extends AbstractPatientCalculation {
	...
	public CalculationResultMap evaluate(Collection<Integer> cohort, Map<String, Object> parameterValues,
		...
		for (Integer ptId : cohort) {
			...
			boolean showNcdInitialForm = false;
			...
			if (hasNcdInitialEnc == null) {
				showNcdInitialForm = true;
			}
			
			ret.put(ptId, new BooleanResult(showNcdInitialForm, this));
		}
		return ret;
	}
