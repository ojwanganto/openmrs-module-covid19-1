...
group by e.patient_id, e.encounter_id
    ON DUPLICATE KEY UPDATE
      ...
      consented_for_covid_test=VALUES(consented_for_covid_test),
...
group by e.patient_id, e.encounter_id
    ON DUPLICATE KEY UPDATE
      ...
      drug_side_effect=VALUES(drug_side_effect),
      voided=VALUES(voided);
...
group by e.patient_id, e.encounter_id
    ON DUPLICATE KEY UPDATE
      ...
      case_classification=VALUES(case_classification),
      eligible_for_therapeutics=VALUES(eligible_for_therapeutics),
      molnupiravir_given=VALUES(molnupiravir_given),
      paxlovid_given=VALUES(paxlovid_given),
      tocilizumab_given=VALUES(tocilizumab_given),
      baricitinib_given=VALUES(baricitinib_given),
      other_given=VALUES(other_given),
      action_taken=VALUES(action_taken),
